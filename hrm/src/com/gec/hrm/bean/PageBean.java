...
public class PageBean<T> {
	private int rowCount; // 总数据条数totalRecordSum
	private int pageSize = 3; // 页面大小
	private int pageNow; // 当前页面号pageIndex
	private int pageCount; // 总页数totalPageSum
...
//	}
	...
	public String toString() {
		return "PageBean [rowCount=" + rowCount + ", pageSize=" + pageSize + ", pageNow=" + pageNow + ", pageCount="
				+ pageCount + ", list=" + list + "]";
	}
