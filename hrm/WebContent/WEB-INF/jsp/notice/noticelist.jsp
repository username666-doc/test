...
<body>
	...
	<form name="noticeform" method="post" id="noticeform"
		...
		<!-- 配置pageIndex的隐藏域 -->
		<input type="hidden" name="pageIndex" value="${PageBean.pageNow}" id="pageIndex">
			...
			<tr valign="top">
				<td height="20">
					<table width="100%" border="1" cellpadding="5" cellspacing="0"
						...
						<c:forEach items="${requestScope.PageBean.list}" var="notice"
							varStatus="stat">
							<tr id="data_${stat.index}" align="center" class="main_trbg"
								...
								<td>${notice.name }</td>
								<td><f:formatDate value="${notice.create_date}" type="date"
										dateStyle="long" /></td>
