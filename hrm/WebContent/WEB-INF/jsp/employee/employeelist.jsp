...
<head>
	...
	function pagerJump()
	{
		var page_size=$('#pager_jump_page_size').val();
 		...
 		if (!regu.test(page_size)||page_size < 1 || page_size >${PageBean.pageCount})
 		{
 			alert('请输入[1-'+ ${PageBean.pageCount} +']之间的页码！');	
 		}else
 		{
	   ...
	   $("#checkAll").click(function(){
 	   ...
 	   $("#query").click(function(){
 		    $("#pageIndex").attr("value",1);
 		  	$("#empform").attr("action", "${ctx}/queryemp.action");
 		 	$("#empform").submit();
 	   })
...
<body>
	...
	<form name="empform" method="post" id="empform" action="${ctx}/queryemp.action">
		<input type="hidden" name="pageIndex" value="${PageBean.pageNow}"
			id="pageIndex" />
	  ...
	  <tr valign="top">
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${requestScope.PageBean.list}" var="employee" varStatus="stat">
